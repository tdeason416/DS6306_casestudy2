...
```{r}
print('Attrition rate of employees making less than $2318 monthly (excluding Sales Rep\'s):')
    mean(data_binned[data_binned$monthlyincome == "[ 1009, 2318)" & data_binned$jobrole != 'Sales Representative','attrition'])
print('Attrition rate of employees making between $2318 and $2696 monthly (excluding Sales Rep\'s):')
