...
* That cluster of percent quit at 34.5% is starting to look a little suspicious, like there may be a very strong covariance within those gruops, which would make those varaibles slightly less valuable, but first we are going to have to generate our dummy varaibles across the main dataset.
